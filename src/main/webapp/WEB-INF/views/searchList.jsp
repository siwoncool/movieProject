					...
					<tr>
						<td colspan="5" class="trcenter">
							<!-- 페이징 처리 --> <!-- [처음]페이지에 대한 처리 --> <c:if
								...
								<a
									href="MMF020?category=${search.category}&keyword=${search.keyword}&page=1&limit=${search.limit}"><c:out
										value="<< 처음" /></a>
								...
								<a
									href="MMF020?category=${search.category}&keyword=${search.keyword}&page=${search.page-1}&limit=${search.limit}"><c:out
										value="< 이전" /></a>
								...
								<c:choose>
									...
									<c:otherwise>
										<span class="space1"><a
											href="MMF020?category=${search.category}&keyword=${search.keyword}&page=${i}&limit=${search.limit}">${i}
										</a></span>
									</c:otherwise>
								...
								<a
									href="MMF020?category=${search.category}&keyword=${search.keyword}&page=${search.maxPage}&limit=${search.limit}"><c:out
										value="마지막 >>" /></a>
